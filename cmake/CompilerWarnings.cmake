...
# metadata_set_warnings(<target> [PUBLIC|PRIVATE|INTERFACE])
#
# Applies a strict warning set per compiler. Adds -Werror / /WX when
# METADATA_WARNINGS_AS_ERRORS is ON.
function(metadata_set_warnings target)
    ...
    if(METADATA_WARNINGS_AS_ERRORS)
